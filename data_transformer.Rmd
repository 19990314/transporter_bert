...
# Function to check file type and read accordingly
...
for (file_name in names(hgnc_df_list)) {
  ...
  print(file_name)
  print(length(filtered_table$Gene))
  cat(paste(filtered_table$Gene, ", "))

  # Define output file path
  output_file <- file.path(output_dir_hgnc_filtered_deg, paste0("filtered_brain_DEGs_by_", file_name))
  ...
  dot_plot <- DotPlot(combined_cell, features = feature_genes, group.by = "organ") +
  labs(x = "Organ", y = "Gene") +
